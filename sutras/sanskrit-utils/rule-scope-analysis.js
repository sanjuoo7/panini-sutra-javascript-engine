/**
 * Rule Scope Analysis Utilities
 * Extracted from Sutra 1.1.72: येन विधिस्तदन्तस्य
 * 
 * @fileoverview Utilities for analyzing the scope and application of Sanskrit grammatical rules
 */
 ...
 */
export const TRADITIONAL_VIDHI_EXAMPLES = {
 ...
 * @returns {boolean} True if suffix-based
 */
export function isSuffixSpecification(specification) {
  if (!specification || typeof specification !== 'string') return false;
 ...
 * @param {string} specification - The rule specification
 * @returns {boolean} True if phoneme class-based
 */
export function isPhonemeClassSpecification(specification) {
  if (!specification || typeof specification !== 'string') return false;
 ...
 * @param {string} specification - The rule specification
 * @returns {boolean} True if morphological
 */
export function isMorphologicalSpecification(specification) {
  if (!specification || typeof specification !== 'string') return false;
 ...
 * @param {string} specification - The rule specification
 * @returns {boolean} True if category-based
 */
export function isCategorySpecification(specification) {
  if (!specification || typeof specification !== 'string') return false;
 ...
 * @param {string} specification - The suffix specification
 * @param {Object} context - Context information
 * @returns {boolean} True if suffix matches
 */
export function checkSuffixMatch(word, specification, context = {}) {
  if (!word || !specification || typeof word !== 'string' || typeof specification !== 'string') {
    return false;
  }
  ...
  if (specification === 'तद्धित') {
    // Check if word ends with तद्धित suffixes
  ...
  if (specification === 'स्त्री') {
    // Check if word ends with feminine markers
 ...
 * @param {string} word - The word to check
 * @param {string} specification - The phoneme class specification
 * @param {Object} context - Context information
 * @returns {boolean} True if phoneme class matches
 */
export function checkPhonemeClassMatch(word, specification, context = {}) {
  if (!word || !specification || typeof word !== 'string' || typeof specification !== 'string') {
    return false;
  }
  ...
  if (specification === 'अच्') {
    // Vowels - check for explicit vowels or vowel marks
 ...
 * @param {string} word - The word to check
 * @param {string} specification - The morphological specification
 * @param {Object} context - Context information
 * @returns {boolean} True if morphological pattern matches
 */
export function checkMorphologicalMatch(word, specification, context = {}) {
  if (!word || !specification || typeof word !== 'string' || typeof specification !== 'string') {
    return false;
  }
  ...
  if (specification.includes('धातु')) {
    ...
    return Boolean(context.isVerbalRoot || context.containsRoot || word.includes('√'));
  }
  
  if (specification.includes('प्रातिपदिक')) {
    // Check if word is a nominal stem - must have explicit context
    return Boolean(context.isNominalStem || context.isProlog);
  }
 ...
 * @param {string} word - The word to check
 * @param {string} specification - The category specification
 * @param {Object} context - Context information
 * @returns {boolean} True if category matches
 */
export function checkCategoryMatch(word, specification, context = {}) {
  if (!word || !specification || typeof word !== 'string' || typeof specification !== 'string') {
    return false;
  }
  
  if (specification.includes('संज्ञा')) {
    return Boolean(context.isNoun || context.grammaticalCategory === 'noun');
  }
  
  if (specification.includes('क्रिया')) {
    return Boolean(context.isVerb || context.grammaticalCategory === 'verb');
  }
  
  if (specification.includes('विशेषण')) {
    return Boolean(context.isAdjective || context.grammaticalCategory === 'adjective');
  }
 ...
 */
export function checkSpecificationMatch(word, specification, context = {}) {
  if (!word || !specification || typeof word !== 'string' || typeof specification !== 'string') {
    return false;
  }
 ...
 */
export function isWithinVidhiScope(word, vidhiSpecification, context = {}) {
 ...
 */
export function analyzeVidhiScope(vidhiSpecification, candidateWords = [], context = {}) {
  const result = {
 ...
 * @param {string} specification - The rule specification
 * @returns {Array} Traditional examples for the specification
 */
export function getTraditionalExamples(specification) {
  const examples = [];
 ...
 */
export function getVidhiScopeBoundary(specification, context = {}) {
  const boundary = {
    specification,
    includes: [],
    excludes: [],
 ...
 */
export function getVidhiScopeExamples() {
  return {
